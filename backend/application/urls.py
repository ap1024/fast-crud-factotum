...
My_Urls = (
    [	
        # 注释编号:workspace.json__urls464817:PublicResource是公共资源模块
        # path('',include('PublicResource.urls')),
        #这里的crud_demo是指django创建的应用名称crud_demo
        # path('',include('crud_demo.urls')),
        # 注释编号:django-vue-admin__urls054617:
        # path('',include('it_mis.urls')),
        path('', include('mansible.urls')),
