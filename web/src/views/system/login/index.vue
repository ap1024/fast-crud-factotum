	...
	<div class="login-container flex z-10">
		<div class="login-left">
			<div class="login-left-logo">
				...
				<!--  注释编号:django-vue3-admin__index384214: 取消logo的显示-->
				<!-- <img :src="logoMini" /> -->

				<div class="login-left-logo-text">

					<!-- 注释编号:django-vue3-admin__index433714:左上角名称显示-->
					<span>Oadmin</span>
		...
		<div class="login-right flex z-10">
			<div class="login-right-warp flex-margin">
				...
				<div class="login-right-warp-mian">
					...
					<!-- 注释编号:django-vue3-admin__index462814:把登陆介面的名称修改为资源管理系统-->
					<!-- <div class="login-right-warp-main-title">{{ getThemeConfig.globalTitle }} 欢迎您！</div> -->
					<div class="login-right-warp-main-title">资源管理系统</div>
		...
		<!-- 注释编号:django-vue3-admin_index122514 -->
		<!-- 功能说明: 取消登陆页面的版本说明 -->
...
// import logoMini from '/@/assets/logo-mini.svg';  //注释编号:django-vue3-admin__index274314:取消登陆左上角的logo导入
