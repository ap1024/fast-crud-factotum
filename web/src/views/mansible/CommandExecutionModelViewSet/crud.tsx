			...
			columns: {
				task_id: {
					...
					form: {
						...
						rules: [{ required: true, message: '此字段必填，ansible_runner运行生成，测试手工填写' }],
						component: {
							placeholder: '此字段必填，ansible_runner运行生成，测试手工填写',
						},
					},
				},
				command: {
					...
					form: {
						helper: {
							render() {
								return <div style={"color:blue"}>命令必需要填写的</div>;
								}
							},
						rules: [{ required: true, message: '此字段必填，测试手工填写' }],
						component: {
							placeholder: '此字段必填，测试手工填写',
						},
					},
				},
