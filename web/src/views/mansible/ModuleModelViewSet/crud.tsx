			...
			actionbar: {
				buttons: {
						export:{
                            ...
                            show: auth('ModuleModelViewSet:Export'),
							text:"导出",//按钮文字
							title:"导出",//鼠标停留显示的信息
                            click(){
                        ...
                        add: {
                            show: auth('ModuleModelViewSet:Create'),
                        },
				}
			},
            rowHandle: {
                ...
                buttons: {
                    view: {
                        type: 'text',
						order: 1,
                        show: auth('ModuleModelViewSet:Retrieve')
                    },
                    edit: {
                        type: 'text',
						order: 2,
						show: auth('ModuleModelViewSet:Update')
                    },
					copy: {
                        type: 'text',
						order: 3,
						show: auth('ModuleModelViewSet:Copy')
                    },
                    remove: {
                        type: 'text',
						order: 4,
						show: auth('ModuleModelViewSet:Delete')
                    },
                },
            },
			columns: {
                ...
                description: {
					...
					form: {
						rules: [{ required: true, message: '模块信息必填' }],
						component: {
							placeholder: '请输入模块信息',
						},
					},
